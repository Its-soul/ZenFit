...
def main():
    p=argparse.ArgumentParser();p.add_argument("versions",nargs="*",default=["1.0.0","0.2.0","1.1.0"]);p.add_argument("--models-dir",type=Path,default=Path("../data/models/indian_food"));args=p.parse_args();rows=[]
