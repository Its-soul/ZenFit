...
The old `app/ai` path remains operational. `app/zenfit_ai` is the migration target and deliberately reuses existing DB, Redis, Qdrant, events, authentication, and realtime infrastructure.
