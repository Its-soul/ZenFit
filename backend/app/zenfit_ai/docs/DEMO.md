...
docker compose up -d
docker compose exec backend python -m app.zenfit_ai.scripts.setup_models
docker compose exec backend python -m app.zenfit_ai.scripts.backfill_memory --seed-development
