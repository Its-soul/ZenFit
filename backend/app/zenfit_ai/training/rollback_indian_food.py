...
def main():
    p=argparse.ArgumentParser();p.add_argument("version");p.add_argument("--environment",choices=("development","production"),default="development");p.add_argument("--models-dir",type=Path,default=Path("app/zenfit_ai/models/indian_food"));args=p.parse_args()
