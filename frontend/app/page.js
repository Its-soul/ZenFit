    ...
    <main className="min-h-screen overflow-x-clip bg-[#070b12] text-slate-100">
      ...
      <section id="about" className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-normal sm:text-4xl">Clear enough for busy days. Flexible enough for real ones.</h2>
      ...
      <section id="how-it-works" className="border-y border-slate-800/80 bg-slate-900/45 px-5 py-20 sm:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            <p className="eyebrow">How the day stays connected</p>
            <h2 className="mt-3 text-3xl font-black tracking-normal sm:text-4xl">Log what matters. Get one useful next move.</h2>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-normal sm:text-4xl">Start with the connected plan.</h2>
          <p className="mt-4 leading-7 text-slate-400">Create an account to enter the real onboarding flow. Subscription packaging can stay separate until backend billing exists.</p>
          <Link href="/auth/register" className="mt-7 inline-flex min-h-12 items-center gap-2 rounded-xl bg-emerald-300 px-5 font-bold text-slate-950 outline-none hover:bg-emerald-200 focus-visible:ring-2 focus-visible:ring-emerald-100">Build my plan <ArrowRight className="h-4 w-4" /></Link>
        </div>
      </section>
