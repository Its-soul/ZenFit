...
2. AI evaluation datasets under `backend/app/ai/evaluation/datasets`.
...
| AI prompt regression dataset | `backend/app/ai/evaluation/datasets/prompt_regression_cases.json` | `backend/app/ai/evaluation/prompt_tests.py` | Static evaluation cases. |
| Recommendation evaluation dataset | `backend/app/ai/evaluation/datasets/recommendation_cases.json` | `backend/app/ai/evaluation/recommendation_tests.py` | Static evaluation cases. |
...
### `backend/app/ai/evaluation/datasets/prompt_regression_cases.json`
...
- `backend/app/ai/evaluation/prompt_tests.py`
- `backend/app/ai/evaluation/runner.py`
- `scripts/evaluate_ai.py`

### `backend/app/ai/evaluation/datasets/recommendation_cases.json`
...
- `backend/app/ai/evaluation/recommendation_tests.py`
- `backend/app/ai/evaluation/runner.py`
- `scripts/evaluate_ai.py`
